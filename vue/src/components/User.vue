...
<div>
    <el-collapse v-model="activeName" accordion>
        ...
        <el-collapse-item title="添加CI" name="4">
            <br>
            <el-input v-model="ciname" placeholder="请输入工程名称" clearable>
            <template slot="prepend">工程</template>
            </el-input>
            <br><br>
            <el-input v-model="citoken" placeholder="请输入CI Private Token" clearable>
            <template slot="prepend">秘钥</template>
            </el-input>
            <br><br>
            <el-button type="primary" @click="add_ci">添加CI</el-button>
        </el-collapse-item>
    </el-collapse>
    <br><br>
...
export default {
    ...
    methods: {
        ...
        add_ci() {
            ...
            var params_data = {'name':this.ciname,'token':this.citoken}
            var body_data = {}
            this.axios({
                baseURL:this.url,
                url:'v1/ci/',
