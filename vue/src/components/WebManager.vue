...
export default {
    ...
    data() {
        return {
            ...
            mpcloudUrl_options:[
                ...
                'lable':'https://172.16.9.88',
                'value':'https://172.16.9.88'
                }
            ],
            pre:'',
            next:'',
    ...
    created() {
        ...
        if (this.userId==2) {
            var new_mpcloud = {
                'lable':'https://autotest.longsys.com',
                'value':'https://autotest.longsys.com'
            }
            this.mpcloudUrl_options.splice(this.mpcloudUrl_options.length,1,new_mpcloud)
            this.mpcloudUrl = 'https://autotest.longsys.com'
        }
    },
    filters:{
